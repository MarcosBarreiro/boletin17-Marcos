...
public class Xeometria {
	...
	/**
	 * Recibe la hipotenusa y uno de los catetos y devuelve el cateto restante
	 * 
	 * @param hipotenusa
	 * @param catetoA
	 * @return catetoB
	 */
	public double teoremaPitagoras(double catetoA, double hipotenusa) {
		// catetoA o hipotenusa nulos o negativos devuelve error -1
		if (catetoA <= 0 || hipotenusa <= 0) {
			return -1;
		}
		// CatetoA mayor á hipotenusa devolve error -2
